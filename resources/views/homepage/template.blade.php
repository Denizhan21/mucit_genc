    ...
    <header class="fixed-header">
        <div class="header-menu">
            <div class="navbar">
                ...
                <?php if (\Illuminate\Support\Facades\Auth::user()->authority=='student') { ?>
                    <div class="inline-item d-flex align-items-center">
                        <div class="dropdown dropdown-cart">
                            <button class="dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                <i class="icofont-shopping-cart"></i>
                        ...
                        <div class="dropdown dropdown-admin">
                            <button class="dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                    <span class="media">
                                        <span class="item-img">
                                            ...
                                            <?php if (!empty(\Illuminate\Support\Facades\Auth::user()->avatar)) { ?>
                                                <img style="width: 44px;height: 44px" src="/{{\Illuminate\Support\Facades\Auth::user()->avatar}}" alt="{{\Illuminate\Support\Facades\Auth::user()->name}}">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <ul class="admin-options">
                                    ...
                                    <?php if (\Illuminate\Support\Facades\Auth::user()->authority=='admin' OR \Illuminate\Support\Facades\Auth::user()->authority=='teacher') { ?>
                                    <li><a href="{{route('admin.index')}}">Panele Git</a></li>
                                    <?php   } ?>
