                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            @foreach($club  as $key=>$clubs)
                                @if(\Illuminate\Support\Facades\Auth::user()->authority=='admin' OR (\Illuminate\Support\Facades\Auth::user()->authority=='teacher' and $clubs->teacher == \Illuminate\Support\Facades\Auth::user()->name))
                                <tr>
                                    <td>{{$clubs->name}}</td>
                                    @if(\Illuminate\Support\Facades\Auth::user()->authority=='admin')
